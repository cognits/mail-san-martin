...
$scope.sendTheMail = function() {
	    ...
	    "13 calle Zona Viva": [
	        {
	            ...
	            "schedule": "Lunes y Martes 6:00 a.m. a 8:30 p.m., Miércoles a Viernes 6:00 a.m. a 10:00 p.m. y Domingos 7:00 a.m. a 7:00 p.m.",
	        }
	    ],
	    "9a Calle Zona 14": [
	        {
	    ...
	    "Col. El Maestro, Vista Hermosa": [
	        {
	            ...
	            "schedule": "Lunes a Sábado 6:00 a.m. a 8:00 p.m. y Domingo de 7:00 a.m. a 6:00 p.m.",
	        }
	    ],
	    "Condado Concepción": [
	        {
	            ...
	            "schedule": "Lunes a Miércoles 6:00 a.m. a 8:30 p.m. y Jueves a Sábado 6:00 a.m. a 10:00 p.m.",
	        }
	    ],
	    ...
	    "Escala Carretera a El Salvador": [
	        {
	            ...
	            "schedule": "Domingo a Miércoles 7:00 a.m. a 9:00 p.m. y Jueves a Sábado 7:00 a.m. a 10:00 p.m.",
	        }
	    ],
	    "Eskala Roosevelt": [
	        {
	    ...
	    "Plaza Ferco": [
	        {
	            ...
	            "schedule": "Lunes a Sábado 6:00 a.m. a 8:00 p.m. y Domingo de 7:00 a.m. a 7:00 p.m.",
	        }
	    ],
	...
	var messageBody = "Hola " + to + '!\n\nTe damos un cordial saludo de parte de Panaderia San Martin.\n\nPara nosotros es un gusto felicitarte y notificarte que ' + from + ' te manda un saludo por su '+ occasion +' y te envia el siguiente mensaje: \n\n"' + messege +'."\n\nAdemas te mando un obsequio a través de nuestras tiendas y lo puedes venir el ' + date + ' en nuestra tienda ubicada en: \n'+ store +"\nDireccion: "+address+"\nTelefono: "+ telephone +"\nHorario: "+ schedule +"\n\n\nCualquier consulta contactanos a nuestros telefonos para nosotros sera un gusto atenderte.";
